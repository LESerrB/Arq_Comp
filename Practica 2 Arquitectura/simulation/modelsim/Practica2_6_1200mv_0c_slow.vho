...
-- out_state[3]	=>  Location: PIN_C11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- out_state[2]	=>  Location: PIN_A12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- out_state[1]	=>  Location: PIN_F9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- out_state[0]	=>  Location: PIN_B12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst8|reloj~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \inst8|esiguiente~feeder_combout\ : std_logic;
SIGNAL \inst8|esiguiente~q\ : std_logic;
SIGNAL \inst8|reloj~0_combout\ : std_logic;
SIGNAL \inst8|reloj~q\ : std_logic;
SIGNAL \inst8|reloj~clkctrl_outclk\ : std_logic;
...
\inst8|reloj~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \inst8|reloj~q\);
...
\inst8|esiguiente~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
\inst8|reloj~0\ : cycloneive_lcell_comb
-- Equation(s):
...
-- Location: CLKCTRL_G6
\inst8|reloj~clkctrl\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \inst8|reloj~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst|esiguiente[1]~2_combout\ = (\inst|esiguiente\(2) & ((\inst|esiguiente\(3)) # (!\inst|esiguiente\(0)))) # (!\inst|esiguiente\(2) & (\inst|esiguiente\(3) & !\inst|esiguiente\(0)))
...
-- Equation(s):
-- \inst|esiguiente[1]~4_combout\ = (\inst|esiguiente\(1) & ((\inst|esiguiente[1]~2_combout\))) # (!\inst|esiguiente\(1) & (\inst|esiguiente[1]~3_combout\ & !\inst|esiguiente[1]~2_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|esiguiente[1]~3_combout\,
...
-- Equation(s):
-- \inst|esiguiente[0]~0_combout\ = (\inst|esiguiente\(1)) # ((\S[0]~input_o\ & (\S[1]~input_o\ & !\inst|esiguiente\(2))))
...
-- Equation(s):
-- \inst|esiguiente[0]~1_combout\ = (\inst|esiguiente\(3) & (\inst|esiguiente\(2) $ ((!\inst|esiguiente\(0))))) # (!\inst|esiguiente\(3) & (!\inst|esiguiente\(0) & (\inst|esiguiente\(2) $ (!\inst|esiguiente[0]~0_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1000011010000011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	...
	datad => \inst|esiguiente[0]~0_combout\,
...
-- Equation(s):
-- \inst|Mux5~1_combout\ = (\inst|esiguiente\(0) & (((\inst|esiguiente\(1))))) # (!\inst|esiguiente\(0) & (!\S[0]~input_o\ & (!\S[1]~input_o\ & !\inst|esiguiente\(1))))
...
-- Equation(s):
-- \inst|Mux5~2_combout\ = (\inst|Mux5~0_combout\) # ((\inst|Mux5~1_combout\ & (!\inst|esiguiente\(3) & !\inst|esiguiente\(2))))
